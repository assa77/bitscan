...
call :exec icl.exe -O3t -Qm32 -QxHost -nologo -W3 -Qwd1786 -Qstd=c99 bitscan.c -o%out%bitscan-32.exe -Fa%out%bitscan-32.lst -FAcs
endlocal & if errorlevel 1 goto end
setlocal
call "%__intel__%" intel64 >nul
call :exec icl.exe -O3t -Qm64 -QxHost -nologo -W3 -Qwd1786 -Qstd=c99 bitscan.c -o%out%bitscan-64.exe -Fa%out%bitscan-64.lst -FAcs
if errorlevel 1 endlocal & goto end
call :exec icl.exe -Qmic -O3 -m64 -mmic -nologo -masm=intel -w3 -wd1786 -std=c99 -DINTEL_SYNTAX bitscan.c -o%out%bitscan.mic -Fa%out%bitscan-mic.lst
endlocal & if errorlevel 1 goto end
:no_icl
...
call :exec cl.exe /Oxt /nologo /W3 /wd4996 bitscan.c /Fe%out%bitscan-ms32.exe /FAcs /Fa%out%bitscan-ms32.lst
endlocal & if errorlevel 1 goto end
setlocal
call "%__msc__%" amd64 >nul
set TARGET_VS_ARCH=x86_amd64
call :exec cl.exe /Oxt /nologo /W3 /wd4996 bitscan.c /Fe%out%bitscan-ms64.exe /FAcs /Fa%out%bitscan-ms64.lst
endlocal & if errorlevel 1 goto end
